        ...
        connect: (() => {
            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    body.sendMessage('You have spawned! Welcome to INC Arras.');
    ...
    let makenpcs = (() => {
        ...
        return () => {
            ...
            // Bots
                ...
                // Slowly upgrade them
                bots.forEach(o => {
                  if (o.upgrades) o.define(ran.choose(o.upgrades)); // Or define() IDK what works. I barely use arras anymore.
                  if (o.skill.level < 45) {
                        o.skill.score += 750;
                        o.skill.maintain();
                    }
    ...
    let makefood = (() => {
        ...
        function getFoodClass(level) {
            ...
            switch (level) {
                ...
                case 6: a = Class.massivePentagon; break;
                case 7: a = Class.moremassivePentagon; break;
